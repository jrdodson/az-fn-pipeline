...
public class Sort {
    ...
    public Sort withIsSelected(Boolean isSelected) {
        this.isSelected = isSelected;
        return this;
    }
    ...
    public Sort withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        Sort rhs = ((Sort) other);
        return ((((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.isSelected == rhs.isSelected)||((this.isSelected!= null)&&this.isSelected.equals(rhs.isSelected))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))));
    }
